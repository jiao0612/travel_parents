...
public class SMSUtils01 {
     ...
     * @param param
     * AccessKeyID:
     *         LTAI5tDYptHEbG6yxeTKEcyY
     * AccessKeySecret:
     *          MXSzX4QZwtO4kpasNg7vhbBeZFu0oG
     */
    public static void sendShortMessage(String phoneNumbers,String param) throws Exception{
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI5tDYptHEbG6yxeTKEcyY";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "MXSzX4QZwtO4kpasNg7vhbBeZFu0oG";// 你的accessKeySecret，参考本文档步骤2
        ...
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_218730092");
